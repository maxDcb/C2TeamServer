...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("dotnetExec", {"action": "runDll", "module_name": "lib", "type_or_method": "Run", "arguments": "arg1 arg2"}, "dotnetExec runDll lib Run arg1 arg2"),
        ...
        ("ipConfig", {}, "ipConfig"),
        ("kerberosUseTicket", {"ticket_artifact": "ticket.kirbi"}, "kerberosUseTicket ticket.kirbi"),
        ...
        ("psExec", {"auth_mode": "-u", "username": "DOMAIN\\user", "password": "pw", "target": "host1", "service_artifact": "svc.exe"}, "psExec -u DOMAIN\\user pw host1 svc.exe"),
        ("pwSh", {"action": "run", "command_or_script": "Get-Process"}, "pwSh run Get-Process"),
        ("pwd", {}, "pwd"),
