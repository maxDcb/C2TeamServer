...
class TeamServerFileTransferCommandPreparer final : public TeamServerCommandPreparer
{
public:
    TeamServerFileTransferCommandPreparer(
...
private:
    ...
    TeamServerCommandPreparerResult prepareDownload(
        const TeamServerCommandPreparerContext& context,
        C2Message& c2Message) const;
    TeamServerCommandPreparerResult prepareUpload(
        const TeamServerCommandPreparerContext& context,
        C2Message& c2Message) const;
